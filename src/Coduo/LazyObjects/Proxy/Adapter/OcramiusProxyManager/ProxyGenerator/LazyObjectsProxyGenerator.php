...
namespace Coduo\LazyObjects\Proxy\Adapter\OcramiusProxyManager\ProxyGenerator;

use Coduo\LazyObjects\Proxy\Adapter\OcramiusProxyManager\MethodGenerator\GetWrappedObject;
use Coduo\LazyObjects\Proxy\Adapter\OcramiusProxyManager\PropertyGenerator\WrappedObjectProperty;
...
class LazyObjectsProxyGenerator implements ProxyGeneratorInterface
{
    public function generate(ReflectionClass $originalClass, ClassGenerator $classGenerator)
    {
        ...
        $interfaces          = array(
            ...
            'Coduo\\LazyObjects\\WrappedObject',
        );
